...
class MigrationCustomerImporter
{
    private MigrationCustomerCreator $customerCreator;

    public function __construct(?MigrationCustomerCreator $customerCreator = null)
    {
        $this->customerCreator = $customerCreator
            ?? app(MigrationCustomerCreator::class);
    }

    public function import(MigrationSession $session,MigrationImportBatch $batch,array $mapping): MigrationImportBatch 
    {
        ...
        if ($batch->entity_type !== 'customers') {
            throw new RuntimeException(
                'Import batch must be for customers.'
            );
        }
        ...
        if (!$validationResult) {
            throw new RuntimeException(
                'Customer migration must be validated before import.'
            );
        }
